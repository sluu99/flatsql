...
public class TestHelper {
    ...
    static {
        ...
        if (System.getenv("TRAVIS") != null) {
            ...
            DB_NAME = String.format("flatsql_test_%d", System.currentTimeMillis());
            DB_USER = "root";
        }
        BASE_CONNECTION_STRING = String.format("jdbc:mysql://127.0.0.1/?user=%s", DB_USER);
        CONNECTION_STRING = String.format("jdbc:mysql://127.0.0.1/%s?user=%s", DB_NAME, DB_USER);
    }
